...
db.pragma('foreign_keys = ON'); // FIX #1 — SQLite does not enforce FKs without this
...
db.exec(`
  CREATE TABLE IF NOT EXISTS users (
    ...
    locked_until TEXT,
    last_login TEXT,             -- FIX #9 — track last login time
  ...
  CREATE TABLE IF NOT EXISTS custody_events (
    ...
    evidence_id TEXT NOT NULL REFERENCES evidence(id) ON DELETE RESTRICT, -- FIX #8
    case_number TEXT,
  ...
  CREATE TABLE IF NOT EXISTS qr_tokens (
    id TEXT PRIMARY KEY,
    evidence_id TEXT NOT NULL REFERENCES evidence(id) ON DELETE CASCADE, -- FIX #8
